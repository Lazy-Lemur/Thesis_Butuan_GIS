...
String query = "SELECT "+request.getParameter("parameter")+" as "+request.getParameter("parameter")+", date FROM bxu_data WHERE year = "+request.getParameter("year")+" AND brgy = '"+request.getParameter("brgy")+"' ORDER BY year";
