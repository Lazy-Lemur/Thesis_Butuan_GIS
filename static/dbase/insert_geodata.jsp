...
String query1 = "INSERT INTO dynamic_table (id, brgy, population, employed, unemployed, underemployed, year) "
        + "VALUES ((SELECT MAX(id)+1 FROM dynamic_table), '"+request.getParameter("brgy")+"', "+request.getParameter("population")+", "
        + ""+request.getParameter("employed")+", "+request.getParameter("unemployed")+", "+request.getParameter("underemployed")+", "
