...
//           String query = "SELECT dyn."+request.getParameter("parameter")+" as "+request.getParameter("parameter")+", stat.brgy as brgy, st_asgeojson(ST_Centroid(geom)), stat.sqkm as sqkm FROM static_table as stat, dynamic_table as dyn WHERE dyn.year = "+request.getParameter("year")+" AND stat.brgy = dyn.brgy";
          String query = "SELECT dyn.population as pop, dyn.employed as emp, dyn.unemployed as unemp, dyn.underemployed as under, stat.brgy as brgy, st_asgeojson(ST_Centroid(geom)), stat.sqkm as sqkm FROM static_table as stat, dynamic_table as dyn WHERE dyn.year = 2015 AND stat.brgy = dyn.brgy";
